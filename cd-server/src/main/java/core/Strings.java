package core;
/**
 * This class defines FUSEKI endpoint Strings used by Repository class
 * @author stan
 *
 */
public class Strings {
  /**
   * Datasets default uri
   */
	public static String DEFAULT_URI="http://crowddata.abdn.ac.uk/datasets/";
